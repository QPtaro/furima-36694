class User < ApplicationRecord
  ...
  validates :first_name, presence: true, format: { with: /\A[ぁ-んァ-ン一-龥々-]+\z/, message: 'に全角文字を使用してください' }
  validates :last_name, presence: true, format: { with: /\A[ぁ-んァ-ン一-龥々-]+\z/, message: 'に全角文字を使用してください' }
